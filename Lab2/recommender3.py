...
class recommender:
   ...
   def computeDeviations(self):
      ...
      return (self.deviations,self.frequencies)

      #plt.bar(range(len(self.deviations)), self.deviations.values(), align='center')
      #plt.xticks(range(len(self.deviations)), list(self.deviations.keys()))
      #plt.show()
